                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="dashboard_header_title">
                                        <h3> List Mentee</h3>
                                        <h4 style="color: #828bb2">Tổng số mentee: 
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="dashboard">Dashboard</a> <i class="fas fa-caret-right"></i> List-All-Mentee</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="QA_section">
                            ...
                            <div class="QA_table mb_30">
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><table class="table lms_table_active dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1531px;">
                                        <thead>
                                            <tr role="row">
                                                <th scope="col" class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 137px;" aria-label="title: activate to sort column ascending">Full Name</th>
                                                <th scope="col" class="sorting_asc" tabindex="0" rowspan="1" colspan="1" style="width: 192px;" aria-label="Category: activate to sort column descending" aria-sort="ascending">Account</th>
                                                <th scope="col" class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 194px;" aria-label="Teacher: activate to sort column ascending">Avatar</th>
                                                <th scope="col" class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 185px;" aria-label="Lesson: activate to sort column ascending">Gender</th><th scope="col" class="sorting" tabindex="0"  rowspan="1" colspan="1" style="width: 136px;">Total Hours</th>
                                                <th scope="col" class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 110px;" aria-label="Price: activate to sort column ascending">Skills</th><th scope="col" class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 157px;">Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="x" items="${lst}">  
                                                <tr role="row" class="odd">
                                                    <th scope="row" tabindex="0" class=""> <a href="#" class="question_content"> ${x.mentee_name}</a></th>
                                                    <td class="sorting_1">${x.mentee_account}</td>
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${x.mentee_avatar_img != null}">
                                                                <img src="${x.mentee_avatar_img}" alt="Mentee"/>
                                                            </c:when>  
                                                            <c:otherwise>
                                                                <img src="https://mentori.vn/assets/images/avatar.jpg" alt="Mentee"/>
                                                            </c:otherwise>  
                                                        </c:choose> 
                                                    </td>  
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${x.mentee_gender == 1}">
                                                                <i style="font-size: 20px;" class="fa-solid fa-mars-stroke"></i>
                                                            </c:when>  
                                                            <c:when test="${x.mentee_gender == 2}">
                                                                <i style="font-size: 20px;" class="fa-solid fa-venus"></i>
                                                            </c:when>  
                                                        </c:choose> 
                                                    </td>
                                                    <td>${x.mentee_hours}</td>
                                                    <td>
                                                        <c:forEach var="y" items="${list}">
                                                            <c:if test="${y.menteeId eq x.mentee_id}">
                                                                <img src="${y.skillImage}" alt="${y.skillName}"/>
                                                            </c:if>
                                                        </c:forEach>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${x.mentee_status == 1}">
                                                                <a style="cursor: default;" href="#" class="status_btn">Active</a>
                                                            </c:when>  
                                                            <c:when test="${x.mentee_status == 0}">
                                                                <a style="cursor: default;" href="#" class="status_btn1">None</a>
                                                            </c:when>  
                                                        </c:choose> 
                                                    </td>
                                                </tr>
