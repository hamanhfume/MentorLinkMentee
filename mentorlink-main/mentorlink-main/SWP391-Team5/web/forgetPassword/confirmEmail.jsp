            ...
            <div class="content-wrap nopadding">
                ...
                <div class="card card_login divcenter noradius noborder allmargin modal-padding card-login-custom"
                    ...
                    <div class="card-body nopadding">
                        ...
                        <p class="mess">We have just sent 1 6-digit confirmation code to your email. Please check your email and enter the confirmation code below!</p>
                        <div id="change-content">
                            <div class="center">

                            </div>

                            <form id="show_lost_password" action="verifyCode" method="POST" class="nobottommargin" name="" autocomplete="off">
                                
                                <div class="mb_10 send_lost_password">
                                    <label for="">Confirm code:</label>
                                    <input id="email_lost_password" type="text" placeholder="XXX-XXX"
                                           name="confirm" value="" class="form-control not-dark login-form-username" />
                                    <p style="font-size: 0.75em;">(*)Note: The confirm code is only valid for 2 minutes</p>
                                </div>
                            ...
                            <div class="mb_10 nobottommargin center">
                                <a href="forgetPassword" class="">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
