...
(function($){
	...
	SEMICOLON.header = {
		...
		topsearch: function(){
			...
			$(document).on('click', function(event) {
				...
				if (!$(event.target).closest('#top-messenger').length) { $topMess.toggleClass('top-messenger-open', false); }
				if (!$(event.target).closest('#top-notify').length) { $topNotify.toggleClass('top-notify-open', false); }
			...
			$("#top-search-trigger").off( 'click' ).on( 'click', function(e){
                ...
                $topMess.toggleClass('top-messenger-open', false);
                $topNotify.toggleClass('top-notify-open', false);
				$( '#primary-menu > ul, #primary-menu > div > ul' ).toggleClass('d-block', false);
				$pagemenu.toggleClass('pagemenu-active', false);
		...
		topcart: function(){
			...
			$("#top-notify-trigger").off( 'click' ).on( 'click', function(e){
				$pagemenu.toggleClass('pagemenu-active', false);
				$topNotify.toggleClass('top-notify-open');
                $topCart.toggleClass('top-cart-open', false);
                $topMess.toggleClass('top-messenger-open', false);
				e.stopPropagation();
				e.preventDefault();
			...
			$("#top-messenger-trigger").off( 'click' ).on( 'click', function(e){
				$pagemenu.toggleClass('pagemenu-active', false);
                $topCart.toggleClass('top-cart-open', false);
                $topMess.toggleClass('top-messenger-open');
                $topNotify.toggleClass('top-notify-open', false);
				e.stopPropagation();
				e.preventDefault();
			});
		...
		carousel: function(){
			...
			$carousel.each( function(){
				...
				element.owlCarousel({
					...
					nav: elementNav,
					navText: ['<img class="" src="assets/images/left-arrow.png" />','<img class="" src="assets/images/right-arrow.png" />'],
	...
	var $window = $(window),
		...
		$topCart = $('#top-cart'),
		$topMess = $('#top-messenger'),
		$topNotify = $('#top-notify'),
